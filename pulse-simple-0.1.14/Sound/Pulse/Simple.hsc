...
instance Storable SampleSpec where
    alignment _= #const offsetof(struct {char x__; pa_sample_spec (y__); }, y__)
...
instance Storable ChannelMap where
    alignment _= #const offsetof(struct {char x__; pa_channel_map (y__); }, y__)
    sizeOf _= #const offsetof(struct {char x__; pa_channel_map (y__); }, y__)
...
instance Storable BufferAttr where
    alignment _= #const offsetof(struct {char x__; pa_buffer_attr (y__); }, y__) 
    sizeOf _= #const offsetof(struct {char x__; pa_buffer_attr (y__); }, y__)
